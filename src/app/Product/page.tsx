        ...
        <div>
            <div>
                <div className="mt-[120px] w-full  sm:h-[150px] flex items-center flex-col">
                    ...
                    <div className="flex w-[80%]  mt-4 gap-16 items-center  flex-col sm:flex-row ">
                        <h1 className="font-inter font-[600] text-[24px] sm:text-[36px] text-black">All Products</h1>
            ...
            <div className='w-full h-auto flex justify-center items-center'>
                <div className='w-full h-[200px] flex flex-col justify-between '>
                    <h1 className='text-[32px] lg:text-[60px] text-center'>Or subscribe to the newsletter</h1>
                    <div className='flex lg:flex-row flex-col  gap-4 justify-center items-center'>
                        <Input placeholder='Email address...' className='   w-[220px] lg:w-[640px]' />
                        <button className="w-[171px] h-[52px] text-[16px] text-white mt-4 border bg-cgreen border-cgreen rounded-[5px] hover:bg-transparent hover:text-black transition-all duration-500">Submit</button>
                    </div>
            ...
            <div className="flex w-full  mt-[90px] gap-16 justify-center items-center  flex-col sm:flex-row ">
                <h1 className="font-inter font-[600] text-[32px] lg:text-[60px] text-black text-center">Follow products and discounts on Instagram</h1>
            ...
            <div className='w-full flex h-auto justify-center items-center mt-11'>
                <div className='w-full lg:w-[80%] flex justify-center items-center flex-wrap gap-4'>
                    <Image src={chair1} alt='' className='w-[200px] h-[200px]' />
                    <Image src={chair2} alt='' className='w-[200px] h-[200px]' />
                    <Image src={chair3} alt='' className='w-[200px] h-[200px]' />
                    <Image src={chair4} alt='' className='w-[200px] h-[200px]' />
                    <Image src={chair3} alt='' className='w-[200px] h-[200px]' />
                    <Image src={chair2} alt='' className='w-[200px] h-[200px]' />
